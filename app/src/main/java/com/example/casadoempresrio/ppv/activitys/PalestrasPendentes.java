...
public class PalestrasPendentes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_palestras_pendentes);

        configuraToolBar();
        Tools.getInstance().configuraListaPalestras(this);
        Tools.getInstance().configuraFiltroCategoriaPendentes(this);
    }

    void configuraToolBar(){
        Toolbar my_toolbar = findViewById(R.id.my_toolbar_pal_pendentes);
        setSupportActionBar(my_toolbar);

        Objects.requireNonNull(getSupportActionBar()).setTitle("Palestras Pendentes");
    ...
    protected void onStart() {
        ...
        Tools.getInstance().atualizaTelaPendentes(this, null);
